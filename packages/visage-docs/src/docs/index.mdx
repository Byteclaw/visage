...
Visage is a design system for [React](https://reactjs.org/) applications. It's goal is to provide you components for rapid UI development.
...
Each React application that wants to use Visage as it's design system needs to wrap application in `DesignSystem` component.

If your application requires to be responsive then you need to use `ResponsiveDesignSystem` otherwise you are good to go with `DesignSystem`.

### Non Responsive Applications

In order to start with Non Responsive Application you need to import [DesignSystem](./components/design-system) component. This component doesn't use any breakpoint detection.
...
As was already said above, in order to use Visage for responsive application you need to import [ResponsiveDesign](./components/responsive-design-system) component. Under the hood the component by default uses [window.matchMedia](https://developer.mozilla.org/en-US/docs/Web/API/Window/matchMedia) API to match breakpoints and set up a current device breakpoint.
